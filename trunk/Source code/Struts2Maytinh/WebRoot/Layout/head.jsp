...
<%@ taglib prefix="s" uri="/struts-tags" %>
 <title>Home</title>
    ...
    <script src="/resource/js/Vegur_500.font.js" type="text/javascript"></script> 
    <script src="/resource/js/FF-cash.js" type="text/javascript"></script>      
    <script src="/resource/js/tms-0.3.js" type="text/javascript"></script>
